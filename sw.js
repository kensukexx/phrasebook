...
const CACHE_NAME = "phrasebook-shell-v4";
const SHELL_FILES = ["./", "./index.html", "./words3000.html", "./words3000-data.js", "./phrases100-data.js", "./manifest.json", "./icon-192.png", "./icon-512.png"];
